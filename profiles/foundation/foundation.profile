...
function foundation_form_install_configure_form_alter(&$form, $form_state) {
  // Add profile as site name.
  $form['site_information']['site_name']['#default_value'] = 'Foundation';
	//On submit, execute foundation_profile_install function
	$form['#submit'][] = '_foundation_profile_install_configure_form_submit';
}

function _foundation_profile_install_configure_form_submit($form, &$form_state) {
...
function foundation_install_tasks_alter(&$tasks, $install_state) {
  ...
  $tasks['install_finished']['function'] = 'foundation_install_finished';
}

function foundation_install_finished(&$install_state) {
